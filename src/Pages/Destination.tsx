...
const Destination: React.FC = () => {
  ...
  return (
    <section className="w-full sm:h-232 flex bg-cover bg-no-repeat bg-center bg-[url('/background-destination-mobile.jpg')] sm:bg-[url('/background-destination-tablet.jpg')] md:bg-[url('/background-destination-desktop.jpg')] justify-center pt-20 sm:pt-30 md:pt-40">
